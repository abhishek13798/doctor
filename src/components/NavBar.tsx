...
const NavBar: React.FC = () => {
  ...
  const navItems = ["Home", "About", "Testimonials", "Services", "AI Assistant", "Techniques", "Blog", "FAQ", "Contact"];
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, item: string) => {
    ...
    } else if (itemLower === 'blog') {
      sectionId = 'blog';
    } else if (itemLower === 'faq') {
      sectionId = 'faq';
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Button
              ...
              className="flex items-center justify-center"
            >
              <a href="https://www.instagram.com/kunjcare?igsh=c3Q0Y3h4c2d0aWZo&utm_source=qr" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                <InstagramIcon className="mr-2 h-4 w-4 flex-shrink-0" />
                Instagram
              </a>
            </Button>
          </div>
